...
import { DetailSnapComponent } from ".";
import { HSRecord } from "../../store/hsCounter/types";
import { MemoryRouter } from "react-router-dom";

const detailsRecord: HSRecord = {
  dbn: "02M260",
...
describe("DetailSnapComponent UnitTest", () => {
  test("Render DetailSnapComponent", () => {
    render(
      <MemoryRouter initialEntries={["/02M260"]}>
        <DetailSnapComponent record={detailsRecord} />
      </MemoryRouter>
    );
